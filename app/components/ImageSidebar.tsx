        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 w-full sm:w-96 h-full bg-white dark:bg-slate-900 shadow-xl z-40 border-l border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col"
            >
              {/* 侧边栏头部 */}
              ...
              <div className="flex-1 overflow-y-auto p-4">
                {displayResults.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full text-center text-slate-500 dark:text-slate-400 p-6">
                    <ImageIcon className="h-16 h-16 mb-4 text-slate-300 dark:text-slate-600" />
