...
import { HamburgerMenuIcon, LockClosedIcon, SunIcon, MoonIcon } from './ui/icons'
    ...
    <div className="flex items-center justify-between mb-10">
      <div className="flex items-center">
        <Link href="/" className="mr-4">
          <div className="w-14 h-14 rounded-2xl shadow-lg transform rotate-12 hover:rotate-0 transition-transform duration-300 overflow-hidden">
            <Image
              src="/static/icon.png"
              alt="Logo"
              width={56}
